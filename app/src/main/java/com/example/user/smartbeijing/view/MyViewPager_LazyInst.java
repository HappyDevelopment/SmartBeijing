...
/**
 * 低版本的viewPager  可以实现懒加载， 设置缓存为0
 * 高版本修改了， 最低是1
 */
public class MyViewPager_LazyInst extends ViewGroup {
    ...
    public MyViewPager_LazyInst(Context context) {
        super(context);
        initViewPager();
    }

    public MyViewPager_LazyInst(Context context, AttributeSet attrs) {
        super(context, attrs);
        initViewPager();
    }
